...
/**
 * class for implementing player aggressive strategy methods and implement behavior interface
 */
public class AI_Aggressive implements Behaviour, java.io.Serializable {
	...
	/**
	 * attack function for aggressive player
	 */
	public void Attack() {
	...
	/**
	 * fortify function for aggressive player
	 */
	public void Fortify() {
	...
	/**
	 * reinforcement function for aggressive player
	 */
	...
	/**
	 * post attack function for aggressive player
	 */
	...
	/**
	 * play card function for aggressive player
	 */
